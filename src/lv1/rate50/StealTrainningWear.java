...
public class StealTrainningWear {
    public int solution(int n, int[] lost, int[] reserve) {
        ...
        List<Integer> reserveListCopy = List.copyOf(reserveList);

        int currentSize = reserveList.size();
        reserveList.removeAll(lostList);
        lostList.removeAll(reserveListCopy);

        currentSize = currentSize - reserveList.size();
